...
namespace our {
    ...
    protected:
        ...
        double deltatime;
        // Virtual functions to be overrode and change the default behavior of the application
    ...
    public:
        ...
        void setdeltatime(double current , double last){deltatime=current-last;}
